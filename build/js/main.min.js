...
/***/ "./js/functions/accardeon.js":
/*!***********************************!*\
  !*** ./js/functions/accardeon.js ***!
  \***********************************/
/*! exports provided: onAccardeon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onAccardeon", function() { return onAccardeon; });
...
var buttons = _toConsumableArray(document.querySelectorAll('[data-button="accardeon"]'));
var accardeonLists = _toConsumableArray(document.querySelectorAll('[data-section="accardeon"]'));
var changeHeight = function changeHeight(evt) {
  var item = evt.target.closest('[data-section="accardeon"]');
  if (item.dataset.open === 'false') {
    accardeonLists.forEach(function (list) {
...
var onAccardeon = function onAccardeon() {
  buttons.map(function (item) {
    item.addEventListener('click', function (evt) {
      return changeHeight(evt);
    });
  });
};
...
/***/ "./js/functions/checkbox.js":
/*!**********************************!*\
  !*** ./js/functions/checkbox.js ***!
  \**********************************/
/*! exports provided: addEventCheckbox */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addEventCheckbox", function() { return addEventCheckbox; });
var checkboxIcons = document.querySelectorAll('[data-icon="checkbox"]');
var checkboxInputs = document.querySelectorAll('[data-input="checkbox"]');
var changeIcon = function changeIcon() {
  checkboxIcons.forEach(function (item) {
    var checkboxInput = item.closest('label').querySelector('[data-input="checkbox"]');
...
var addEventCheckbox = function addEventCheckbox() {
...
/***/ "./js/functions/company-info.js":
/*!**************************************!*\
  !*** ./js/functions/company-info.js ***!
  \**************************************/
/*! exports provided: onCompanyInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onCompanyInfo", function() { return onCompanyInfo; });
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var button = document.querySelector('[data-button="company"]');
var text = _toConsumableArray(document.querySelectorAll('[data-text="company"]'));
var openCompanyInfo = function openCompanyInfo() {
...
var onCompanyInfo = function onCompanyInfo() {
...
/***/ "./js/functions/popup.js":
/*!*******************************!*\
  !*** ./js/functions/popup.js ***!
  \*******************************/
/*! exports provided: popupOn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "popupOn", function() { return popupOn; });
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var buttons = _toConsumableArray(document.querySelectorAll('[data-button="popup"'));
var popup = document.querySelector('[data-id="popup"]');
var checkPopup = function checkPopup() {
  return popup.classList.toggle('popup--hide');
};
var popupOn = function popupOn() {
  buttons.map(function (item) {
    return item.addEventListener('click', checkPopup);
  });
...
/***/ "./js/functions/tel-mask.js":
/*!**********************************!*\
  !*** ./js/functions/tel-mask.js ***!
  \**********************************/
/*! exports provided: onTelMask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onTelMask", function() { return onTelMask; });
var inputTel = document.querySelectorAll('[data-input="tel"]');
var onTelMask = function onTelMask() {
...
/***/ "./js/functions/validate.js":
/*!**********************************!*\
  !*** ./js/functions/validate.js ***!
  \**********************************/
/*! exports provided: validForms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validForms", function() { return validForms; });
var nameForms = document.querySelectorAll('[data-input="name"]');
var telForms = document.querySelectorAll('[data-input="tel"]');
var formCheckboxes = document.querySelectorAll('[data-input="checkbox"]');
var validForms = function validForms() {
  nameForms.forEach(function (item) {
    item.addEventListener('invalid', function () {
      item.setCustomValidity('Введите ваше Имя!');
    });
  });
  telForms.forEach(function (item) {
    item.addEventListener('invalid', function () {
...
/* harmony import */ var _functions_popup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/popup */ "./js/functions/popup.js");
/* harmony import */ var _functions_company_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/company-info */ "./js/functions/company-info.js");
/* harmony import */ var _functions_accardeon__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/accardeon */ "./js/functions/accardeon.js");
/* harmony import */ var _functions_tel_mask__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/tel-mask */ "./js/functions/tel-mask.js");
/* harmony import */ var _functions_checkbox__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./functions/checkbox */ "./js/functions/checkbox.js");
/* harmony import */ var _functions_validate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./functions/validate */ "./js/functions/validate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_functions_popup__WEBPACK_IMPORTED_MODULE_3__["popupOn"])();
    Object(_functions_company_info__WEBPACK_IMPORTED_MODULE_4__["onCompanyInfo"])();
    Object(_functions_accardeon__WEBPACK_IMPORTED_MODULE_5__["onAccardeon"])();
    Object(_functions_tel_mask__WEBPACK_IMPORTED_MODULE_6__["onTelMask"])();
    Object(_functions_checkbox__WEBPACK_IMPORTED_MODULE_7__["addEventCheckbox"])();
    Object(_functions_validate__WEBPACK_IMPORTED_MODULE_8__["validForms"])();
