...
/* harmony import */ var _modules_scrollToModule_init_scrolls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scrollToModule/init-scrolls */ "./js/modules/scrollToModule/init-scrolls.js");
/* harmony import */ var _modules_textExpander_init_textExpander__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/textExpander/init-textExpander */ "./js/modules/textExpander/init-textExpander.js");
/* harmony import */ var _modules_masks_init_masks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/masks/init-masks */ "./js/modules/masks/init-masks.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_scrollToModule_init_scrolls__WEBPACK_IMPORTED_MODULE_2__["initScrolls"])();
    Object(_modules_masks_init_masks__WEBPACK_IMPORTED_MODULE_4__["initMasks"])();
    var breakpoint = window.matchMedia('(max-width:770px)');

    var breakpointChecker = function breakpointChecker() {
      if (breakpoint.matches) {
        Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_5__["initAccordion"])();
        isMobileView = true;
      } else {
        return;
      }
    ...
    breakpointChecker();
    Object(_modules_textExpander_init_textExpander__WEBPACK_IMPORTED_MODULE_3__["initTextExpanders"])(isMobileView);
  });
}); // ---------------------------------
  ...
  _createClass(Accordion, [{
    ...
    value: function _init() {
      ...
      if (this._expandMenuButtons.length) {
        ...
        this._expandMenuButtons.forEach(function (element) {
          _this.closeSingleElement(element.dataset.expandMenuButton);
        });
      }
    }
  }, {
    ...
    value: function _documentClickHandler(evt) {
      ...
      var expandButtonElement = target.closest('[data-expand-menu-button]');
      evt.preventDefault();
    ...
    key: "closeSingleElement",
    value: function closeSingleElement(elementToToggle) {
      var _this2 = this;

      var toggleElements = document.querySelectorAll("[data-hide-footer-element=\"".concat(elementToToggle, "\"]"));

      if (!toggleElements.length) {
        return;
      }

      document.querySelector("[data-expand-menu-button=\"".concat(elementToToggle, "\"]")).classList.add('is-hidden');
    ...
    key: "openSingleElement",
    value: function openSingleElement(elementToToggle) {
      var _this3 = this;
      ...
      document.querySelector("[data-expand-menu-button=\"".concat(elementToToggle, "\"]")).classList.remove('is-hidden');
      document.removeEventListener('click', this._documentClickHandler);
      toggleElements.forEach(function (element) {
    ...
    value: function toggleElements() {
      ...
      var siblingsToToggle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._siblingsToToggle;
      var thisButton = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this._clickedButton;

      this._expandMenuButtons.forEach(function (element) {
        var currentElementData = element.dataset.expandMenuButton;

        if (currentElementData !== siblingsToToggle) {
          _this4.closeSingleElement(element.dataset.expandMenuButton);
        }
      });
...
/*!************************************************!*\
  !*** ./js/modules/accordion/init-accordion.js ***!
  \************************************************/
/*! exports provided: footerShowHideElements, initAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "footerShowHideElements", function() { return footerShowHideElements; });
...
var footerShowHideElements;

var initAccordion = function initAccordion() {
  footerShowHideElements = new _accordion__WEBPACK_IMPORTED_MODULE_0__["Accordion"]();
...
/*!****************************************!*\
  !*** ./js/modules/masks/init-masks.js ***!
  \****************************************/
/*! exports provided: inputMaskElements, initMasks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inputMaskElements", function() { return inputMaskElements; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMasks", function() { return initMasks; });
/* harmony import */ var _masks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./masks */ "./js/modules/masks/masks.js");

var inputMaskElements;

var initMasks = function initMasks() {
  inputMaskElements = new _masks__WEBPACK_IMPORTED_MODULE_0__["Masks"]();
...
var Masks = /*#__PURE__*/function () {
  ...
  _createClass(Masks, [{
    ...
    key: "createMasks",
    value: function createMasks(maskElements) {
      var _this = this;

      maskElements.forEach(function (element) {
        var maskValue = element.dataset.phoneMask;
        element.setAttribute('maxlength', maskValue.length);
        element.addEventListener('keyup', function (evt) {
          _this._documentInputHandler(evt);
        });
      });
    }
  }, {
    key: "_documentInputHandler",
    value: function _documentInputHandler(evt) {
      var target = evt.target;
    ...
    key: "checkCurrentValue",
    value: function checkCurrentValue(evt) {
      var mask = evt.target.dataset.phoneMask;
      var maskLength = mask.length;
      var i;
      var j;
      var value = evt.target.value;
      var newValue = '';
      var regexpValue = value.replace(/(\+7)*\D/g, '');
      j = 0;

      for (i = 0; i < maskLength; i++) {
        var isInt = !isNaN(parseInt(regexpValue[j], 10));
...
var settings = {
  ...
  'pop-up-callme-modal': {
    openCallback: function openCallback() {
      var openedModal = document.querySelector('.modal.is-active');
      setTimeout(function () {
...
/*!***************************************************!*\
  !*** ./js/modules/scrollToModule/init-scrolls.js ***!
  \***************************************************/
/*! exports provided: scrollToElements, initScrolls */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollToElements", function() { return scrollToElements; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initScrolls", function() { return initScrolls; });
/* harmony import */ var _scrolls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scrolls */ "./js/modules/scrollToModule/scrolls.js");

var scrollToElements;

var initScrolls = function initScrolls() {
  scrollToElements = new _scrolls__WEBPACK_IMPORTED_MODULE_0__["ScrollTo"]();
...
var ScrollTo = /*#__PURE__*/function () {
  ...
  _createClass(ScrollTo, [{
    ...
    value: function scrollTo() {
      ...
      var scrollToElementName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._scrollToElement;
      var scrolledToElement = document.querySelector("[data-scrolled-to-element=\"".concat(scrollToElementName, "\"]"));
...
/*!******************************************************!*\
  !*** ./js/modules/textExpander/init-textExpander.js ***!
  \******************************************************/
/*! exports provided: expandTextElements, initTextExpanders */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandTextElements", function() { return expandTextElements; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTextExpanders", function() { return initTextExpanders; });
/* harmony import */ var _textExpander__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./textExpander */ "./js/modules/textExpander/textExpander.js");

var expandTextElements;

var initTextExpanders = function initTextExpanders(isMobileView) {
  expandTextElements = new _textExpander__WEBPACK_IMPORTED_MODULE_0__["TextExpander"](isMobileView);
...
/*!*************************************************!*\
  !*** ./js/modules/textExpander/textExpander.js ***!
  \*************************************************/
/*! exports provided: TextExpander */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextExpander", function() { return TextExpander; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
  ...
  _createClass(TextExpander, [{
    ...
    value: function _init() {
      if (this._expandTextButtons.length) {
        ...
        this._expandTextButtons.forEach(function (element) {
          element.click();
        });
      }
    }
    ...
    value: function _documentClickHandler(evt) {
      ...
      var expandTextButtonElement = target.closest('[data-expand-text]');
      evt.preventDefault();
      ...
      var expandTextButtonOpen = expandTextButtonElement.dataset.expandTextOpen;
      var expandTextButtonClose = expandTextButtonElement.dataset.expandTextClose;
    ...
    value: function expandText() {
      ...
      var expandTextName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this._expandTextButton;
      var expandTextElements = document.querySelectorAll("[data-expand-text-element=\"".concat(expandTextName, "\"]"));

      if (!expandTextElements) {
        return;
      }

      var expandMobileTextElements = [];

      if (this._mobileExpand === true) {
        expandMobileTextElements = document.querySelectorAll("[data-expand-text-element-mobile=\"".concat(expandTextName, "\"]"));
      }

      document.removeEventListener('click', this._documentClickHandler);
      expandTextElements.forEach(function (element) {
        element.classList.toggle('is-hidden');
      });
      expandMobileTextElements.forEach(function (element) {
