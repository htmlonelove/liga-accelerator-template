...
var btnPopap = document.querySelector('.header__button');
var inputName = document.querySelector('#name-modal');
...
var acc = document.querySelectorAll('.accordion__title');
acc.forEach(function (el) {
  return el.classList.toggle('accordion__title--active');
});
acc.forEach(function (el) {
  return el.addEventListener('click', function (evt) {
    return openAccordion(evt);
  });
});
var openAccordion = function openAccordion(evt) {
  if (evt.target.classList.contains('accordion__title')) {
    ...
    if (!evt.target.classList.contains('accordion__title--active')) {
      acc.forEach(function (el) {
        return el.classList.add('accordion__title--active');
      });
      evt.target.classList.toggle('accordion__title--active');
    }
  }
...
var moreButton = document.querySelector('.about__link');
var moreText = document.querySelector('.about__text');
if (moreText) {
