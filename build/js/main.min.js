...
/* harmony import */ var _modules_open_close_footer_sections_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/open-close-footer-sections.js */ "./js/modules/open-close-footer-sections.js");
/* harmony import */ var _modules_about_company_open_close_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-company-open-close.js */ "./js/modules/about-company-open-close.js");
/* harmony import */ var _modules_open_close_modal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/open-close-modal.js */ "./js/modules/open-close-modal.js");
/* harmony import */ var _modules_use_jquery_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/use-jquery.js */ "./js/modules/use-jquery.js");
/* harmony import */ var _modules_form_elements_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/form-elements.js */ "./js/modules/form-elements.js");
...
Object(_modules_open_close_footer_sections_js__WEBPACK_IMPORTED_MODULE_3__["openCloseFooterSections"])();
Object(_modules_about_company_open_close_js__WEBPACK_IMPORTED_MODULE_4__["aboutCompanyOpenClose"])();
Object(_modules_open_close_modal_js__WEBPACK_IMPORTED_MODULE_5__["openCloseModal"])();
Object(_modules_use_jquery_js__WEBPACK_IMPORTED_MODULE_6__["useJQuery"])();
Object(_modules_form_elements_js__WEBPACK_IMPORTED_MODULE_7__["modalFocus"])();
...
/***/ "./js/modules/about-company-open-close.js":
/*!************************************************!*\
  !*** ./js/modules/about-company-open-close.js ***!
  \************************************************/
/*! exports provided: aboutCompanyOpenClose */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aboutCompanyOpenClose", function() { return aboutCompanyOpenClose; });
var aboutCompanyOpenClose = function aboutCompanyOpenClose() {
  var aboutCompanyOpenButton = document.querySelector('.about-company__button-open');
  var aboutCompanyCloseButton = document.querySelector('.about-company__button-close');
  var companyParagraphThird = document.querySelector('.company-description__paragraph--third');
  var companyParagraphFourth = document.querySelector('.company-description__paragraph--fourth');
  var companyTextHidable = document.querySelector('.company-description__paragraph--hidable');
...
var modalFocus = function modalFocus() {
  var modalForm = document.querySelector('.modal-page__content');
  var focusableElements = modalForm.querySelectorAll('button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="radio"]:not([disabled]), input[type="checkbox"]:not([disabled])');
...
/***/ "./js/modules/open-close-footer-sections.js":
/*!**************************************************!*\
  !*** ./js/modules/open-close-footer-sections.js ***!
  \**************************************************/
/*! exports provided: openCloseFooterSections */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openCloseFooterSections", function() { return openCloseFooterSections; });
var openCloseFooterSections = function openCloseFooterSections() {
  var openNavigationButton = document.querySelector('.footer-navigation__button--open');
  var closeNavigationButton = document.querySelector('.footer-navigation__button--close');
  var navigation = document.querySelector('.footer-navigation__navigation');
  var openAddressButton = document.querySelector('.footer-contacts__button--open');
  var closeAddressButton = document.querySelector('.footer-contacts__button--close');
  var address = document.querySelector('.contacts-container');
...
var modalFieldPhone = document.querySelector('.modal-page__input--phone');
var modalFieldMessage = document.querySelector('.modal-page__input--message');
var modalFieldName = document.querySelector('.modal-page__input--name');
var pageBody = document.querySelector('.page-body');
var openCloseModal = function openCloseModal() {
  var modalCloseButton = document.querySelector('.modal-page__close-button');
  var modalOpenButton = document.querySelector('.main-header__button');
...
/***/ "./js/modules/use-jquery.js":
/*!**********************************!*\
  !*** ./js/modules/use-jquery.js ***!
  \**********************************/
/*! exports provided: useJQuery */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useJQuery", function() { return useJQuery; });
