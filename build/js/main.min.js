...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_textExpander_init_textExpander__WEBPACK_IMPORTED_MODULE_3__["initTextExpanders"])();
...
var initMasks = function initMasks() {
  inputMaskElements = new _masks__WEBPACK_IMPORTED_MODULE_0__["Masks"](); // Используйте в разработке экспортируемую переменную modals, window сделан для бэкэнда
...
var initScrolls = function initScrolls() {
  scrollToElements = new _scrolls__WEBPACK_IMPORTED_MODULE_0__["ScrollTo"](); // Используйте в разработке экспортируемую переменную modals, window сделан для бэкэнда
...
var initTextExpanders = function initTextExpanders() {
  expandTextElements = new _textExpander__WEBPACK_IMPORTED_MODULE_0__["TextExpander"](); // Используйте в разработке экспортируемую переменную modals, window сделан для бэкэнда
