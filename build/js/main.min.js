...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSwiper.initTrainersSlider)();
    (0, _initSwiper.initReviewSlider)();
  });
});
...
},{"./modules/form-validate/form":4,"./modules/index":10,"./modules/init-swiper":11,"./modules/init-tabs":12,"./modules/modals/init-modals":13,"./modules/video":16,"./utils/ios-vh-fix":19}],3:[function(require,module,exports){
"use strict";
...
exports.initTrainersSlider = exports.initReviewSlider = void 0;
var _swiperBundle = _interopRequireWildcard(require("../../../node_modules/swiper/swiper-bundle"));
...
var trainersSlider = document.querySelector('.swiper-container');
var initTrainersSlider = function initTrainersSlider() {
  if (trainersSlider) {
    // eslint-disable-next-line no-unused-vars
    var mySwiper = new _swiperBundle.default('.swiper__slider', {
      direction: 'horizontal',
      loop: true,
...
var initreviewSlider = document.querySelector('.review__swiper');
var initReviewSlider = function initReviewSlider() {
  if (initreviewSlider) {
    // eslint-disable-next-line no-unused-vars
    var mySwiper = new _swiperBundle.default('.review__slider', {
      direction: 'horizontal',
      loop: false,
      IOSEdgeSwipeDetection: true,
      onTouchStart: function onTouchStart() {
...
},{"../../../node_modules/swiper/swiper-bundle":1}],12:[function(require,module,exports){
"use strict";
