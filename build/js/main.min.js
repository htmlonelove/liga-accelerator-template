...
/* harmony import */ var _modules_text_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/text.js */ "./js/modules/text.js");
...
/* harmony import */ var _modules_form_validation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form-validation.js */ "./js/modules/form-validation.js");
/* harmony import */ var _modules_form_validation_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_form_validation_js__WEBPACK_IMPORTED_MODULE_4__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["removeNojsClass"])(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["footerNav"]);
  Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["removeNojsClass"])(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["footerContacts"]);
  Object(_modules_accordion_js__WEBPACK_IMPORTED_MODULE_3__["hideAdditionalText"])();
  Object(_modules_text_js__WEBPACK_IMPORTED_MODULE_2__["changeButtonText"])();
  Object(_modules_text_js__WEBPACK_IMPORTED_MODULE_2__["changeTitleText"])();
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: hideAdditionalText, removeNojsClass, footerNav, footerContacts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hideAdditionalText", function() { return hideAdditionalText; });
...
var footerNav = document.querySelector('[data-footer-navigation]');
var footerContacts = document.querySelector('[data-footer-contacts]');
var footerContactsArea = document.querySelector('[data-footer-contacts-area]');
var footerNavArea = document.querySelector('[data-footer-nav-area]');
var aboutButton = document.querySelector('[data-about-button]');
var aboutDescription = document.querySelectorAll('[data-about-description]');
var aboutDescriptionContainer = document.querySelector('[data-about-description-container]');

// Аккордеон в футере

var removeNojsClass = function removeNojsClass(element) {
  if (element) {
    element.classList.remove('is-nojs');
  }
};
var onClickOpenInfo = function onClickOpenInfo(mainElement, sideElement) {
  return function () {
...
var hideAdditionalText = function hideAdditionalText() {
  if (aboutDescription.length > 2 && aboutButton) {
    for (var i = 2; i < aboutDescription.length; i++) {
  ...
  aboutButton.addEventListener('click', function () {
    ...
    if (aboutButton.classList.contains('is-opened')) {
      ...
      if (windowInnerWidth <= 767) {
        ...
        for (var _i = 2; _i < aboutDescription.length; _i++) {
          aboutDescription[_i].classList.add('hidden');
        }
      } else {
        aboutButton.textContent = 'Подробнее';
        for (var _i2 = 2; _i2 < aboutDescription.length; _i2++) {
          aboutDescription[_i2].classList.add('hidden');
        }
      }
    }
  });
...
var phoneInvalidMassage = document.createElement('span');
...
var onPhoneInput = function onPhoneInput(evt) {
  ...
  var inputNumbersValue = getInputNumbersValue(phoneInput);
  var firstSimbols = '+7';
  ...
  var formattedInputValue = firstSimbols + ' ';
...
function onPhoneChange(evt) {
  ...
  var form = phoneLabel.parentElement;
  var formButton = form.querySelector('button[data-form-button]');
...
var validatePhoneInput = function validatePhoneInput() {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var nameInput = modal.querySelector('input[data-name-input');
...
/*!****************************!*\
  !*** ./js/modules/text.js ***!
  \****************************/
/*! exports provided: changeButtonText, changeTitleText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeButtonText", function() { return changeButtonText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeTitleText", function() { return changeTitleText; });
var mainBlockButton = document.querySelector('[data-button]');
var catalogTitle = document.querySelector('[data-catalog-title]');
...
var changeTitleText = function changeTitleText() {
